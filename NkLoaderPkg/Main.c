...
EFI_STATUS GetMemoryMap(struct MemoryMap *map)
{
	 ...
	 * 	IN OUT EFI_MEMORY_DESCRIPTOR *MemoryMap, // start pointer
	 * 	OUT UINTN *MapKey, // identify
	 * 	OUT UINTN *DescriptorSize, // may not be the same as sizeof(EFI_MEMORY_DESCRIPTOR)
